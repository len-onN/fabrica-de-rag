...
  
 
## 2026-06-28 - Cita��es e Preview de Fonte (RAG)

Ap�s o laborat�rio b�sico, o fluxo de recupera��o exigia uma visualiza��o rica da proced�ncia (grounding). Na branch `feat/citacoes-preview-fonte`, refatoramos as cita��es no frontend. Os metadados visuais ou textuais puros provenientes do RAG agora alimentam os componentes `CitationCardComponent` e `CitationPreviewComponent`.
O preview � apresentado em um painel lateral fluido para n�o ofuscar o contexto. Ele implementa fallback textual na aus�ncia de renderiza��o de PDF nativo e aplica highlights absolutos de BBox sobre os assets extra�dos utilizando as propriedades `pdf_points_top_left`. O build rigoroso do Angular foi validado com sucesso e o fluxo est� completo para as pr�ximas trilhas de observabilidade e analytics.
